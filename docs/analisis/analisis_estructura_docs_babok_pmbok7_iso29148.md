...
- **Contenido NORMATIVO:** Para cada information item (Clause 9)
...
|----------------------------|----------------|-----------------------------------|
| **BRS - Business Requirements Specification** | Requisitos de organización/negocio que justifican el sistema | `necesidades_negocio/*/business_requirements.md` |
| **StRS - Stakeholder Requirements Specification** | Requisitos desde perspectiva de stakeholders/usuarios | `requisitos/requisitos_stakeholders/` |
| **SyRS - System Requirements Specification** | Requisitos técnicos del sistema desde perspectiva del proveedor | `requisitos/requisitos_solucion/` + `diseno_solucion/` |
| **SRS - Software Requirements Specification** | Requisitos específicos de elementos software | `requisitos/requisitos_solucion/software/` |
...
|-------------------|------------|----------------------|-------------------------|
| **Business or Mission Analysis** | ISO/IEC/IEEE 15288:2015, 6.4.1 | - Concept of Operations (ConOps)<br>- Preliminary Operational Concept<br>- Business Case | `necesidades_negocio/*/`<br>`anexos/conceptos_operacionales/` |
| **Stakeholder Needs and Requirements Definition** | ISO/IEC/IEEE 15288:2015, 6.4.2 | - StRS<br>- System Operational Concept (OpsCon)<br>- Operational Scenarios | `requisitos/requisitos_stakeholders/`<br>`tareas_analisis/elicitacion_colaboracion/` |
| **System Requirements Definition** | ISO/IEC/IEEE 15288:2015, 6.4.3 | - SyRS<br>- Software SRS<br>- Requirements Traceability Matrix (RTM) | `requisitos/requisitos_solucion/`<br>`requisitos/trazabilidad_general.md` |
...
| **Feasible** | Trade-off analysis en `tareas_analisis/analisis_estrategico/` |
...
|---------|----------|---------|-----------|-------------------|
| **Necesidad de Negocio** | Business Need (raíz de todo) | Business Case (artefacto) | Problem/Opportunity (6.2.3.3) | `necesidades_negocio/` |
| **Requisito de Negocio** | Business Requirement (objetivo medible) | Business Requirement | BRS Content (9.3) | `requisitos/requisitos_negocio/` |
| **Requisito de Stakeholder** | Stakeholder Requirement (necesidad de usuario) | Stakeholder Requirement | StRS Content (9.4) | `requisitos/requisitos_stakeholders/` |
| **Requisito Funcional** | Solution Requirement - Functional | Functional Requirement | System Function (9.5.5) | `requisitos/requisitos_solucion/funcionales/` |
| **Requisito No Funcional** | Solution Requirement - Quality | Quality Requirement | Quality Attributes (9.5.9) | `requisitos/requisitos_solucion/no_funcionales/` |
| **Requisito de Transición** | Transition Requirement | Transition Requirement | Transition Req. (9.5.17) | `requisitos/requisitos_transicion/` |
| **Tarea de BA** | Task (30 tareas en 6 KAs) | Método (cómo hacer) | Process Activity (6.x.3) | `tareas_analisis/` |
...
│ CARPETA: tareas_analisis/elicitacion_colaboracion/                  │
│ OUTPUT: requisitos/requisitos_stakeholders/                         │
└─────────────────────────────────────────────────────────────────────┘
                                ↓
┌─────────────────────────────────────────────────────────────────────┐
...
│ CARPETA: tareas_analisis/analisis_requisitos_diseno/                │
│ OUTPUT: requisitos/requisitos_solucion/                             │
└─────────────────────────────────────────────────────────────────────┘
                                ↓
┌─────────────────────────────────────────────────────────────────────┐
...
| **5.2.5** | Characteristics of Individual Requirements | Checklist en `gobernanza/checklists/checklist_caracteristicas_req.md` |
| **5.2.6** | Characteristics of Set of Requirements | Validado en tarea 7.2 (Verificar) y 7.3 (Validar) |
| **5.2.7** | Requirement Language Criteria | Guía en `gobernanza/estandares/estandares_documentacion.md` |
| **5.2.8** | Requirements Attributes | Atributos obligatorios en plantilla (ID, Version, Owner, Priority, Risk, Rationale, Type) |
| **6.2** | Business/Mission Analysis Process | `necesidades_negocio/` + `tareas_analisis/analisis_estrategico/` |
| **6.3** | Stakeholder Needs & Req Definition | `requisitos/requisitos_stakeholders/` + `tareas_analisis/elicitacion_colaboracion/` |
| **6.4** | System Requirements Definition | `requisitos/requisitos_solucion/` + `tareas_analisis/analisis_requisitos_diseno/` |
| **6.5.1** | Architecture Definition | `diseno_solucion/arquitectura_sistemas/` |
| **6.5.2** | Verification | `validacion_evaluacion/estrategia_qa/metodos_verificacion.md` (4 métodos ISO) |
| **6.5.3** | Validation | `validacion_evaluacion/evaluacion_solucion/` |
| **6.6** | Requirements Management | `gobernanza/` + `requisitos/trazabilidad_general.md` |
...
Equipo: "requisitos/trazabilidad_general.md - trazabilidad bidireccional Need→Req→Design→Test"
✅ APROBADO
```
...
→ Formulario: tareas_analisis/gestion_ciclo_vida_requisitos/t_5.4_evaluar_cambios/solicitud_cambio_XXX.md
→ Análisis impacto usando RTM en requisitos/trazabilidad_general.md
→ Aprobación: tareas_analisis/gestion_ciclo_vida_requisitos/t_5.5_aprobar/
...
- Migrar Business Cases a `necesidades_negocio/`
...
- Migrar a `requisitos/` manteniendo trazabilidad
...
- Crear estructura BABOK 6 KAs en `tareas_analisis/`
...
- Mover ADRs a `diseno_solucion/arquitectura_sistemas/adr/`
...
|---------|----------|---------|-----------|---------|
| **Business Need** | Problema u oportunidad de alto nivel | Business Case | Problem/Opportunity | `necesidades_negocio/` |
| **Requirement** | Condición documentada necesaria | Condición a cumplir | Statement translating need (3.1.19) | `requisitos/` |
...
| **Task** | Unidad trabajo BA (30 tareas) | - | Process Activity | `tareas_analisis/` |
...
| **Verification** | Confirmar bien especificado | - | Fulfill specified req (3.1.37) | `validacion_evaluacion/` |
| **Validation** | Confirmar satisface necesidad | - | Fulfill intended use (3.1.36) | `validacion_evaluacion/` |
