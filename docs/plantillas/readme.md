...
- `nivel_4_diseno/`: plantillas de arquitectura y diseño detallado.
- `nivel_5_implementacion/`: guías de implementación y runbooks.
- `nivel_6_validacion/`: plantillas de planes y casos de prueba.
- `gobernanza/`: formularios y planes de gestión.
