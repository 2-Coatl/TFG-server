# Requisitos de Solución (SyRS / SRS)
...
- `software/`: SRS por componente software (ISO 9.6).

Cada requisito debe cumplir las características ISO 5.2.5 y atributos definidos en `plantilla_catalogo_requisitos_iso29148.md`.
